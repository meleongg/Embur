  ...
  return (
    <LegalPageLayout title="Privacy Policy">
      ...
      <section className="mb-8">
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2">2.2 Fitness Data</h3>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-bold mb-4">4. Data Storage and Security</h2>
        <p>
        ...
        <p className="mt-2">
          Your fitness data is stored in our secure database and is accessible
          only to you through your authenticated account.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          We will retain your personal information and fitness data for as long
          as your account is active or as needed to provide you with our
          services. If you wish to delete your account, your personal
      ...
      <section className="mb-8">
        ...
        <p>
          To exercise these rights, you can manage most data-related settings
